...
def get_cameras_config() -> dict:
    ...
    from .stream_manager import DEVICE, FRAME_SKIP, HEALTH_INT, MODEL_PATH, STATS_FLUSH
...
def validate_cameras_config() -> list[str]:
    ...
    if max_cams > 16:
        warnings.append(
            f"MAX_CAMERAS={max_cams} — ensure sufficient CPU/RAM for multi-process inference"
        )
...
def get_camera_config(camera_id: str) -> dict:
    ...
    from .registry import get_camera  # noqa: F401
